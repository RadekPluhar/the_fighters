...
export class OperationalFunctions {
    ...
    private yourFight(): void {
        ...
        if (fighterYou.getLife() > 0 && fighterRival.getLife() > 0) {
            ...
            domFunctions.creatingSpacesForAttacks('your-attack', AttackRegister.youAreAboutToAttack, 'choose-hand', 'choose-leg',
                AttackRegister.chooseWhatToAttackWithHand, AttackRegister.chooseWhatToAttackWithLeg, 'choose-hand-button', 'choose-leg-button',
                'HAND', 'LEG', 'hand-or-leg', AttackRegister.chooseWhatToAttackWith, undefined, undefined, undefined, undefined, 'picture-space', 'button-space');
            document.getElementById('choose-hand-button')?.addEventListener('click', () => {
                ...
                document.getElementById('attack-to-head-button')?.addEventListener('click', () => {
                    ...
                    this.progressBarLifeRival(
                        this.formulaForEnergyLossRivalWithImageVariants(resultOfAttack, fighterYou.getTheResultsOfAUnsuccessfulHandToFaceAttack(),
                            fighterYou.getTheResultsOfASuccessfulHandToFaceAttack(), 7));
                ...
                document.getElementById('attack-to-body-button')?.addEventListener('click', () => {
                    ...
                    this.progressBarLifeYou(1);
                    this.progressBarLifeRival(
                        this.formulaForEnergyLossRivalWithImageVariants(resultOfAttack, fighterYou.getTheResultsOfAUnsuccessfulHandToAbdomenAttack(),
                            fighterYou.getTheResultsOfASuccessfulHandToAbdomenAttack(), 5));
                    continuingCombat(this.rivalFight.bind(this));
                });
            });
            document.getElementById('choose-leg-button')?.addEventListener('click', () => {
                ...
                document.getElementById('attack-to-head-button')?.addEventListener('click', () => {
                    ...
                    this.progressBarLifeRival(
                        this.formulaForEnergyLossRivalWithImageVariants(resultOfAttack, fighterYou.getTheResultsOfAUnsuccessfulLegToFaceAttack(),
                            fighterYou.getTheResultsOfASuccessfulLegToFaceAttack(), 10));
                    continuingCombat(this.rivalFight.bind(this));
                });
                document.getElementById('attack-to-body-button')?.addEventListener('click', () => {
                    ...
                    this.progressBarLifeYou(2);
                    this.progressBarLifeRival(
                        this.formulaForEnergyLossRivalWithImageVariants(resultOfAttack, fighterYou.getTheResultsOfAUnsuccessfulLegToAbdomenAttack(),
                            fighterYou.getTheResultsOfASuccessfulLegToAbdomenAttack(), 7));
                    continuingCombat(this.rivalFight.bind(this));
                });
                document.getElementById('attack-to-legs-button')?.addEventListener('click', () => {
                    ...
                    this.progressBarLifeYou(2);
                    this.progressBarLifeRival(
                        this.formulaForEnergyLossRivalWithImageVariants(resultOfAttack, fighterYou.getTheResultsOfAUnsuccessfulLegToLegsAttack(),
                            fighterYou.getTheResultsOfASuccessfulLegToLegsAttack(), 5));
                    continuingCombat(this.rivalFight.bind(this));
                });
            });
    ...
    private rivalFight(): void {
        ...
        if (fighterYou.getLife() > 0 && fighterRival.getLife() > 0) {
            ...
            document.getElementById('protect-head-button')?.addEventListener('click', () => {
                ...
                this.progressBarLifeYou(
                    this.formulaForEnergyLossYouWithImageVariants(resultOfAttack, fighterRival.getYouGotPunchedInTheAbdomenByHandPictures(), 5,
                        fighterRival.getYouGotPunchedInTheAbdomenByLegPictures(), 7, fighterRival.getYouStoppedAPunchToTheFaceByHandPictures(),
                        fighterRival.getYouStoppedAPunchToTheFaceByLegPictures(), 1));
            ...
            document.getElementById('protect-body-button')?.addEventListener('click', () => {
                ...
                this.progressBarLifeRival(degreeOfFatigue);
                this.progressBarLifeYou(
                    this.formulaForEnergyLossYouWithImageVariants(resultOfAttack, fighterRival.getYouGotPunchedInTheFaceByHandPictures(), 7,
                        fighterRival.getYouGotPunchedInTheFaceByLegPictures(), 10, fighterRival.getYouStoppedAPunchToTheAbdomenByHandPictures(),
                        fighterRival.getYouStoppedAPunchToTheAbdomenByLegPictures(), 1));
                continuingCombat(this.yourFight.bind(this));
            });
     ...
     */
    private theResultOfTheFight() {
        let whoIsAWinner: string;
     ...
     */
    private progressBarCharging(progressBar: string, fighter: FighterAbstract) {
     ...
     */
    private formulaForEnergyLossRivalWithImageVariants(resultOfAttack: string[], stoppedAttacks: AttackRegister[], successfulAttacks: AttackRegister[],
        numberOfLoss: number): number {
     ...
     */
    private formulaForEnergyLossYouWithImageVariants(resultOfAttack: string[], gotPunchedByHand: AttackRegister[], gotPunchedByHandNumber: number,
        gotPunchedByLeg: AttackRegister[], gotPunchedByLegNumber: number, stoppedPunchByHand: AttackRegister[], stoppedPunchByLeg: AttackRegister[],
        stoppedPunchNumber: number): number {
